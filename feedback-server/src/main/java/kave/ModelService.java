...
public class ModelService {
    ...
    //need to know what is a valid feedback file might need to delete or change it!
    @Inject
    public ModelService(File dataFolder, File tmpFolder, UploadCleanser cleanser, UniqueFileCreator tmpufc,
